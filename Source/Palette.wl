...
handleShowQueues[] := HandleUIFailure @ Module[{projects, settings, nb, path, cells, timestamp, workspaceName},
...
HandleShowDailys[] := HandleUIFailure @ Handle[_Failure] @ Module[{
	settings,
	timePeriod,
	startDate,
	endDate,
